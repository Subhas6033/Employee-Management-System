...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate(result.user.role === 'admin' ? '/dashboard' : '/employee-dashboard')
    } catch (err) {
    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        ...
        >
          ...
          <p className="mt-8 text-center text-sm text-slate-600 dark:text-slate-400">
            ...
            <Link to="/register" className="text-primary-600 hover:text-primary-700 font-medium dark:text-primary-400">
              Create one
            </Link>
          </p>
        </motion.div>
      ...
      <div className="hidden lg:flex lg:flex-1 bg-slate-900 items-center justify-center p-12">
        <div className="relative w-full max-w-lg">
          ...
          <div className="absolute -bottom-10 -right-10 w-96 h-96 bg-accent-500/30 rounded-full blur-3xl" />
          ...
          <div className="relative card p-8">
            <div className="text-white mb-8">
              ...
              <p className="text-slate-400">
                Join thousands of companies using EMS to streamline their HR operations.
              </p>
            </div>
