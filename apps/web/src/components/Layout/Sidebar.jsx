  ...
  return (
    <>
      ...
      <motion.aside
        ...
        className="fixed top-0 left-0 z-50 h-full w-72 bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-700 flex flex-col lg:translate-x-0 lg:static"
      >
        {/* Logo */}
        ...
        <div className="p-4 border-t border-slate-200 dark:border-slate-700">
          ...
          <button
            ...
            className="w-full mt-2 flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors"
          >
            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
